...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView rvUser, @NonNull SearchBar searchBar, @NonNull SearchView searchView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, progressBar, rvUser, searchBar,
          searchView);
    }
